...
import { MemberAdded } from "../generated/schema"
import { MemberAdded as MemberAddedEvent } from "../generated/GasLimitedPaymaster/GasLimitedPaymaster"
...
describe("Describe entity assertions", () => {
  beforeAll(() => {
    ...
    let newMemberAddedEvent = createMemberAddedEvent(
      poolId,
      memberIndex,
      identityCommitment,
      merkleTreeRoot,
