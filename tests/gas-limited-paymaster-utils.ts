...
export function createMemberAddedEvent(
  ...
  memberAddedEvent.parameters.push(
    new ethereum.EventParam(
      "memberIndex",
      ethereum.Value.fromUnsignedBigInt(memberIndex)
    )
  )
  memberAddedEvent.parameters.push(
    new ethereum.EventParam(
  ...
  memberAddedEvent.parameters.push(
    new ethereum.EventParam(
      "merkleRootIndex",
      ethereum.Value.fromUnsignedBigInt(merkleRootIndex)
    )
  )
...
export function createPoolCreatedEvent(
  ...
  poolCreatedEvent.parameters.push(
    new ethereum.EventParam(
      "joiningFee",
      ethereum.Value.fromUnsignedBigInt(joiningFee)
    )
  )
...
export function createUserOpSponsoredEvent(
  userOpHash: Bytes,
  poolId: BigInt,
  sender: Address,
  ...
  userOpSponsoredEvent.parameters.push(
    new ethereum.EventParam(
      "userOpHash",
